...
internal static class Program
{
    ...
    [STAThread] static int Main(string[] args)
    {
        try
        {
            ...
            File.AppendAllText(Path.Combine(AppDomain.CurrentDomain.BaseDirectory,"F1 Speed Manager.log"),DateTimeOffset.Now.ToString("o")+" Starting "+AppVersion.WindowTitle+Environment.NewLine);
            bool created;
        ...
        catch(Exception e)
        {
            ...
            Log("ERROR: "+message);
            if(args.Length==0)MessageBox.Show(message,AppVersion.WindowTitle+" — stopped safely",MessageBoxButtons.OK,MessageBoxIcon.Error);
            return 1;
        }
    }
}
